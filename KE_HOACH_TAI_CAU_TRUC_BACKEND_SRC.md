...
| 07/08/2026 | 4 | Retrieval và Qdrant chuyển vào `rag/` và `rag/qdrant/`; root module alias giữ CLI/import cũ | 23 passed; Qdrant CLI verify/compile đạt | Backend healthy | Alias 23.608 point, green, optimizer ok | Đạt; không sửa dữ liệu Qdrant |
