...
if __name__ == "__main__":
    ...
    try:
        ...
        text = "BMI trong báo cáo InBody nên được đọc cùng PBF và SMM"
        ...
        texts = [
            "BMI và phần trăm mỡ cơ thể",
            "Chế độ ăn giàu protein khi giảm mỡ",
            "Lịch tập kháng lực cho người mới",
        ]
        ...
        texts1 = ["mỡ nội tạng cao nên làm gì"]
        texts2 = ["giảm mỡ bằng dinh dưỡng và tập luyện", "đau ngực cần đi cấp cứu", "công thức món ăn"]
